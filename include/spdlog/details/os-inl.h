...
#    if defined(SPDLOG_WCHAR_TO_UTF8_SUPPORT) || defined(SPDLOG_WCHAR_FILENAMES) || defined(SPDLOG_MSVC_SINK_UTF8_SUPPORT)
#        include <limits>
#    endif
...
#if (defined(SPDLOG_WCHAR_TO_UTF8_SUPPORT) || defined(SPDLOG_WCHAR_FILENAMES) || defined(SPDLOG_MSVC_SINK_UTF8_SUPPORT)) && defined(_WIN32)
...
#endif // (defined(SPDLOG_WCHAR_TO_UTF8_SUPPORT) || defined(SPDLOG_WCHAR_FILENAMES) || defined(SPDLOG_MSVC_SINK_UTF8_SUPPORT)) && defined(_WIN32)
